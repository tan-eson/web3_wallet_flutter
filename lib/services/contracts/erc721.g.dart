...
class Erc721 extends _i1.GeneratedContract {
  ...
  Future<BigInt> MAX_MULTIMINT({_i1.BlockNum? atBlock}) async {
    final function = self.abi.functions[1];
    assert(checkSignature(function, 'b8fc1051'));
    final params = [];
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> MINT_LIMIT_PER_WALLET({_i1.BlockNum? atBlock}) async {
    final function = self.abi.functions[3];
    assert(checkSignature(function, 'd6c336ed'));
    final params = [];
    final response = await read(function, params, atBlock);
    return (response[0] as BigInt);
  }
  ...
  Future<BigInt> PRICE({_i1.BlockNum? atBlock}) async {
    ...
    assert(checkSignature(function, '8d859f3e'));
    final params = [];
    final response = await read(function, params, atBlock);
    return (response[0] as BigInt);
  }
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> allowedMintCount(_i1.EthereumAddress minter,
      {_i1.BlockNum? atBlock}) async {
    final function = self.abi.functions[5];
    assert(checkSignature(function, 'bb660c0a'));
    final params = [minter];
    final response = await read(function, params, atBlock);
    return (response[0] as BigInt);
  }
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> mint(List<BigInt> ids,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
    final function = self.abi.functions[10];
    assert(checkSignature(function, 'f8e93ef9'));
    final params = [ids];
    return write(credentials, transaction, function, params);
  }
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<RoyaltyInfo> royaltyInfo(BigInt $param9, BigInt salePrice,
      {_i1.BlockNum? atBlock}) async {
    final function = self.abi.functions[15];
    assert(checkSignature(function, '2a55205a'));
    final params = [$param9, salePrice];
    final response = await read(function, params, atBlock);
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<bool> saleIsActive({_i1.BlockNum? atBlock}) async {
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> setBaseURI(String customBaseURI_,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
    final function = self.abi.functions[20];
    assert(checkSignature(function, '55f804b3'));
    final params = [customBaseURI_];
    return write(credentials, transaction, function, params);
  }
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> setSaleIsActive(bool saleIsActive_,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
    final function = self.abi.functions[21];
    assert(checkSignature(function, '02c88989'));
    final params = [saleIsActive_];
    return write(credentials, transaction, function, params);
  }
...
class RoyaltyInfo {
  RoyaltyInfo(List<dynamic> response)
      : receiver = (response[0] as _i1.EthereumAddress),
        royaltyAmount = (response[1] as BigInt);
